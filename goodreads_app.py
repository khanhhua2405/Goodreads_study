...
st.write(f'It looks like you have finished {u_books} books with total of {u_authors} unique authors. Your most read author is {mode_author}!')
...
fig_year_finished = px.bar(books_per_year, x = "Year Finished", y='Count', title='Books Finshed per year')
...
fig_days_finished = px.histogram(books_finished_filtered, x ='days_to_finish', title ='Time Between Date Addad and Date Finished',
